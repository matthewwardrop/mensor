...
of this are provided in the [quickstart](quickstart.md) section.
...
The specifics of this grammar will be explored in more detail in the [quickstart](quickstart.md) .
